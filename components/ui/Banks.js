...
export default function Banks() {
  return (
    <div className='flex flex-col gap-4 bg-black/90 text-white w-full items-center justify-center font-montserrat px-10 pb-20'>
